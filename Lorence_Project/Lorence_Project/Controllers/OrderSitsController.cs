...
namespace Lorence_Project.Controllers
{
    public class OrderSitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderSitID,SitName,date,arrived,confirmedByAdmin")] OrderSit orderSit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderSitID,SitName,date,arrived,confirmedByAdmin")] OrderSit orderSit)
        {
            if (ModelState.IsValid)
            {
